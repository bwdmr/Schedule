...
export interface Returns {
  ...
  /**
   * Convert a selection Date into a schedule Date by including the timerange the date can be scheduled with
   */
  setEndOfDayInterval: (date: Date) => Date;
...
/**
 * Reset a given Date to 00:00 AM
 */
...
export const useSchedule = ({
  ...
  const setEndOfDayInterval = (date: Date) =>
